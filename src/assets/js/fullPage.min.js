  ...
  e.fn.fullpage = function (Q) {
                  ...
                  Qn(0),
                    ...
                    e(m + ", " + M).each(function () {
                      Q.scrollOverflowHandler &&
                        Q.scrollOverflowHandler.remove(e(this)),
            ...
            (Q.scrollBar = Q.scrollBar || Q.hybrid),
                ...
                o.data("fp-styles", o.attr("style")),
                  (function (n, o) {
                    o || 0 !== e(w).length || n.addClass(u),
                      ...
                      Q.paddingBottom &&
                        n.css("padding-bottom", Q.paddingBottom),
                      void 0 !== Q.sectionsColor[o] &&
                        n.css("background-color", Q.sectionsColor[o]),
                      void 0 !== Q.anchors[o] &&
                        n.attr("data-anchor", Q.anchors[o]);
                  })(o, n),
                  (function (n, o) {
                    void 0 !== Q.anchors[o] &&
                      n.hasClass(u) &&
              ...
              Q.navigation &&
                (function () {
                  ...
                  var n = e(L);
                  n.addClass(function () {
                    return Q.showActiveTooltip
                      ? I + " " + Q.navigationPosition
        ...
        ? (!(function () {
            ...
            var a =
              "onwheel" in o.createElement("div")
                ...
                : "DOMMouseScroll";
            "DOMMouseScroll" == a
              ? o[e](t + "MozMousePixelScroll", an, !1)
              : o[e](t + a, an, !1);
          })(),
      ...
      void 0 !== o
        ...
        : (Jn(n, "all", "m"),
          n
            ...
            : (qe(!1),
              (ie || ae) &&
                (Q.autoScrolling && J.off(xe.touchmove),
        ...
        (Oe = a.y),
          ...
          i.find(z).length && t.abs(Ae - Ie) > t.abs(Le - Oe)
            ? !te &&
              ...
              (Ae > Ie ? ue.m.right : ue.m.left && We(i))
            : Q.autoScrolling &&
              de &&
    ...
    function sn(n, o, i) {
      if (void 0 !== n) {
        ...
        (c.activeSection.is(n) && !se) ||
          (Q.scrollBar && K.scrollTop() === c.dtop && !n.hasClass(C)) ||
          (c.activeSlide.length &&
            ((a = c.activeSlide.data("anchor")), (r = c.activeSlide.index())),
          (e.isFunction(Q.onLeave) &&
            !c.localIsResizing &&
            !1 ===
              Q.onLeave.call(
                c.activeSection,
    ...
    function cn(n) {
      !(function (n) {
        ...
        e.isFunction(Q.afterLoad) &&
          !n.localIsResizing &&
          Q.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1),
        Q.scrollOverflow && Q.scrollOverflowHandler.afterLoad(),
      ...
      (l.xMovement = (function (e, n) {
        ...
        !1 ===
          ...
          : (o.addClass(u).siblings().removeClass(u),
            ...
            !Q.loopHorizontal &&
              Q.controlArrows &&
              (a.find(X).toggle(0 !== l.slideIndex),
              a.find(W).toggle(!o.is(":last-child"))),
            a.hasClass(u) &&
              !l.localIsResizing &&
              Nn(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex),
            (function (e, n, o) {
              var i = n.destinyPos;
              if (Q.css3) {
    ...
    function Pn(e) {
      e.hasClass(P) ||
        e
          .addClass(P)
          .wrapInner(
            '<div class="' + x + '" style="height:' + qn(e) + 'px;" />'
          );
    }
    function qn(e) {
      var n = re;
    ...
    function jn(e, n) {
      ...
      if (o.length) {
        var t = (function (e, n) {
          ...
          return (
            o.length || ((e = void 0 !== e ? e : 0), (o = n.find(M).eq(e))), o
          );
        })(n, o);
        e === $ || o.hasClass(u)
          ? Yn(t)
